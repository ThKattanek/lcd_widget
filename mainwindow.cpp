    ...
    , ui(new Ui::MainWindow)
{
    ...
    uint8_t user_char01[] = {0xaa,0x55,0xaa,0x55,0xaa,0x55,0xaa,0x55};
    uint8_t user_char02[] = {0xaa,0xaa,0xaa,0xaa,0xaa,0xaa,0xaa,0xaa};
    uint8_t user_char03[] = {0xff,0x0,0xff,0x0,0xff,0x0,0xff,0x0,0xff};
